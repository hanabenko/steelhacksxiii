...
await page.locator('#observe-toggle').click();await page.reload();await page.locator('#view-top').click();await page.locator('button[data-panel="design"]').click();await page.locator('[data-quick-tool="crosswalk"]').click();await page.screenshot({path:'artifacts/fifth-editing.png'});
