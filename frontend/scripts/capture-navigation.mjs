...
await page.locator('#observe-toggle').click();await page.locator('#campus-view').click();await page.locator('#view-top').click();await page.locator('[data-quick-tool="crosswalk"]').click();await page.screenshot({path:'artifacts/fifth-editing.png'});
