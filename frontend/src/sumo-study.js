export function installSumoStudy({services,container,getSettings,getScene,isBusy,onStart,onFinish}) {
 ...
 panel.innerHTML=`<summary>SUMO · Forbes / Bigelow signal study</summary><p>Compare original signals against your green-phase setting at this junction using the demand slider. Selected weather applies to both scenarios, including braking, following gaps, speed, and pedestrian demand. Campus upgrades and game scores remain separate.</p><p>3 paired trials × 10 simulated minutes. Geometry: OpenStreetMap. Default traffic calibration comes from Fifth / Meyran; slider demand is your assumption.</p><button type="button" data-run-sumo>Run SUMO study</button><button type="button" data-stop-replay hidden>Return to campus traffic</button><p role="status" data-sumo-status></p><div data-sumo-results></div>`;
